...
let audioElement = new Audio('sad/5.mp3');
...
$('.playbutton').each(function(){
    $(this).click(function(){
        ...
        if(audioElement.currentTime > 0 && !audioElement.paused && $(audioElement).attr('src') == 'sad/'+index+'.mp3'){
            //already playing and we click on that song => pause it
            $(this).attr('src','playyy.png');
            audioElement.pause();
        }

        else if(audioElement.currentTime > 0 && audioElement.paused && $(audioElement).attr('src') == 'sad/'+index+'.mp3'){
            ...
            audioElement.src = 'sad/' + index + '.mp3';
            $(this).attr('src','pause.png');
