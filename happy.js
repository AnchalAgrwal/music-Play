...
let audioElement = new Audio('happy/5.mp3');
...
$('.playbutton').each(function(){
    $(this).click(function(){
        ...
        if(audioElement.currentTime > 0 && !audioElement.paused && $(audioElement).attr('src') == 'happy/'+index+'.mp3'){
            //already playing and we click on that song => pause it
            $(this).attr('src','playyy.png');
            audioElement.pause();
        }

        else if(audioElement.currentTime > 0 && audioElement.paused && $(audioElement).attr('src') == 'happy/'+index+'.mp3'){
            ...
            audioElement.src = 'happy/' + index + '.mp3';
            $(this).attr('src','pause.png');
